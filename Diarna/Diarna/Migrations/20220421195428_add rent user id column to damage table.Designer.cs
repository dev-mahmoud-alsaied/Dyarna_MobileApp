...
namespace Diarna.Migrations
{
    ...
    [Migration("20220421195428_add rent user id column to damage table")]
    partial class addrentuseridcolumntodamagetable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diarna.Data.Domain.TblUnitDamages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TblUnitDamages");
                });

            modelBuilder.Entity("Diarna.Data.Domain.TblUnitImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TblUnitId");

                    b.ToTable("TblUnitImages");
                });
            ...
            modelBuilder.Entity("Diarna.Data.Domain.TblUnitImages", b =>
                {
                    b.HasOne("Diarna.Data.Domain.TblUnit", "TblUnit")
                        .WithMany()
                        .HasForeignKey("TblUnitId");

                    b.Navigation("TblUnit");
                });
